...
from core.threading_manager import ThreadingManager, SearchTask, SearchResult
...
class TestThreadingManager(unittest.TestCase):
    ...
    def test_progress_callback(self):
        ...
        self.assertGreater(mock_progress_callback.call_count, 1)
        
        # Check that final progress was 1.0
        final_call = mock_progress_callback.call_args_list[-1]
        # Progress callback is called with (message, progress) as positional args
        self.assertEqual(final_call[0][1], 1.0)  # Second positional argument is progress
