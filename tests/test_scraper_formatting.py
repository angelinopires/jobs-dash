...
class TestIndeedScraperFormatting(unittest.TestCase):
    ...
    def test_format_company_info_valid_data(self) -> None:
        ...
        row_two = {"company_industry": "Finance", "company_num_employees": "1000+"}
    ...
    def test_format_company_info_invalid_data(self) -> None:
        ...
        row_string_nan = {"company_industry": "nan", "company_num_employees": "none", "company_revenue": "null"}
        result = self.scraper._format_company_info(row_string_nan)
        self.assertEqual(result, "N/A")

        # Test with None values
        row_none = {"company_industry": None, "company_num_employees": None, "company_revenue": None}
        result = self.scraper._format_company_info(row_none)
        self.assertEqual(result, "N/A")

        # Test with empty strings
        row_empty = {"company_industry": "", "company_num_employees": "   ", "company_revenue": "n/a"}
    ...
    def test_format_company_info_mixed_data(self) -> None:
        ...
        row_mixed2 = {"company_industry": None, "company_num_employees": "50-100", "company_revenue": "null"}
        result = self.scraper._format_company_info(row_mixed2)
        self.assertEqual(result, "Size: 50-100")

        row_mixed3 = {"company_industry": "Healthcare", "company_num_employees": "", "company_revenue": None}
    ...
    def test_format_company_info_edge_cases(self) -> None:
        ...
        # Test with pandas NA
        row_pandas_na = {"company_industry": pd.NA, "company_num_employees": pd.NA, "company_revenue": pd.NA}
...
class TestIndeedScraperFormattingIntegration(unittest.TestCase):
    ...
    def test_salary_formatting_with_nan(self) -> None:
        ...
        row_all_nan = {"min_amount": np.nan, "max_amount": np.nan, "currency": "nan", "interval": np.nan}
...
class TestFormattingPreventionSuite(unittest.TestCase):
    ...
    def test_all_formatting_functions_handle_nan(self) -> None:
        ...
        for nan_value in nan_values:
            ...
            row = {"company_industry": nan_value, "company_num_employees": nan_value, "company_revenue": nan_value}
            result = self.scraper._format_company_info(row)
